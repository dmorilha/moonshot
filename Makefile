...
main: main.cc buffer.cc freetype.cc freetype.h font.cc font.h poller.cc poller.h screen.h screen.cc vt100.cc vt100.h terminal.cc terminal.h xdg-shell.c xdg-shell.h wayland.cc wayland.h

...
main: main.cc buffer.cc freetype.cc freetype.h font.cc font.h poller.cc poller.h rune.h rune.cc screen.h screen.cc vt100.cc vt100.h terminal.cc terminal.h xdg-shell.c xdg-shell.h wayland.cc wayland.h opengl.cc opengl.h
	...
	$(CXX) $(CXX_FLAGS) $(LD_FLAGS) $(LIBS) -o $@ buffer.o freetype.o font.o main.o poller.o rune.o screen.o terminal.o types.o vt100.o xdg-shell.o wayland.o opengl.o;

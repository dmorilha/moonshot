...
main: main.cc buffer.cc freetype.cc freetype.h poller.cc poller.h screen.h screen.cc vt100.cc vt100.h terminal.cc terminal.h xdg-shell.c xdg-shell.h wayland.cc wayland.h
	...
	$(CXX) $(CXX_FLAGS) $(LIBS) -o $@ buffer.o freetype.o main.o poller.o screen.o terminal.o vt100.o xdg-shell.o wayland.o;
